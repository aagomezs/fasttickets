...
//import { saveVenta, deleteVenta } from '../services/ventaService';
...
const VentaForm = () => {
  ...
  const { ventas, saveVenta: saveVentaHook, deleteVenta: deleteVentaHook } = useVentas();
