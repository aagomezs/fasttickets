...
import { saveVenta, deleteVenta } from '../services/ventaService'; // Asegúrate de importar deleteVenta
...
const VentaForm = () => {
  ...
  const { ventas, saveVenta: saveVentaHook } = useVentas(); // Ajusta el destructuring según sea necesario
  ...
  const handleDelete = async (id) => {
    if (window.confirm('¿Estás seguro de eliminar esta venta?')) {
      await deleteVenta(id); // Usa deleteVenta correctamente
    }
  };
