  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Puedes manejar el error según sea necesario, por ejemplo, navegando a una página de error
      }
    };
  ...
  const handleDelete = async (id) => {
    if (window.confirm('¿Estás seguro de eliminar este producto?')) {
      try {
        ...
        await getAllProductos(); // Actualiza la lista de productos después de eliminar uno
      } catch (error) {
